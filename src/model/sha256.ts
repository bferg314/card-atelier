/**
 * SHA-256 in plain JavaScript. `crypto.subtle` would be shorter, but it only exists in a secure context, so it is
 * missing whenever the app is opened over http:// on a LAN address, which is how the dev server is often used.
 */
